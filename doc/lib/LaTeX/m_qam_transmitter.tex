...
\maketitle
This block generates a MQAM optical signal. It can also output the binary sequence. A schematic representation of this block is shown in figure \ref{MQAM_transmitter_block_diagram}.
...
\begin{center}
	\begin{tabular}{| m{3,5cm} | m{5,1cm} |  m{2,5cm} | m{4cm} | }
		...
		Bit period & setBitPeriod() & double & Número real superior a zero\\ \hline
		Pattern length & setPatternLength() & int & Número inteiro superior zero\\ \hline
		Number of bits & setNumberOfBits() & long & Número inteiro superior a zero\\ \hline
		Number of samples per symbol & setNumberOfSamplesPerSymbol() & int & Número inteiro superior a zero\\ \hline
		...
		Output optical power & setOutputOpticalPower() & int & Número real superio a zero\\ \hline
