...
\hline
netxpto Parameters     & Description 																				 \\ \hline
NumberOfBits           & Gives the number of bits in the encoded string												 \\ \hline  
SamplesPerSymbol       & Establishes the number of samples each bit in the string is given							 \\ \hline  
pLength                & Sets the bit generator pattern length														 \\ \hline  
iqAmplitudesValues     & Sets the state constellation																	 \\ \hline  
outOpticalPower\_dBm   & Sets the optical power, in units of dBm, of the sent signal									 \\ \hline  
