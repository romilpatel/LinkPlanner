...
This document describes a model to simulate a BPSK transmission system in back-to-back configuration.
...
\begin{enumerate}
    ...
    \item{Change figure 1 to increase the lines width and to include the block Sink.}
