...
\label{fig:scheme_homodyne}
\centering
\includegraphics{../figures/scheme_setup.pdf}
%\caption{Balanced double homodyne detection.}
\end{figure}

A state is generated in the MQAM wich is then mixed with in the Optical hybrid with a local oscillator. The 2 pairs of output optical signals are then converted to photodiodes, it's difference calculated and then sampled.
...
These plots show the variance of $\hat{m}$ in function of....
