...
\subsection{Concept of Kramers-Kronig transceiver}
...
\subsubsection{2. What are the requirements for the KK receiver scheme?}
...
\textbf{Single sideband (SSB) signal generation:}\\
...
\end{equation}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{3. How we can use these signals and profit from them?}
