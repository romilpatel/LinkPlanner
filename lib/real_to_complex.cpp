...
// I'm not sure what kind of output will be generated.
...
bool realToComplex::runBlock(void) {
	...
	// Output verification before processing.
	...
	for (int i = 0; i < process; i++) {
		...
		// Output signal type verification.
		// I'll use ComplexValue.
		// If is incorrect, should it end processing?
