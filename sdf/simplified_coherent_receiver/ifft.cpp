...
void Ifft::directTransform(vector<double> &real, vector<double> &imag)
{
...
void Ifft :: transformRadix2(vector<double> &real, vector<double> &imag)
{
...
void Ifft ::transformBluestein(vector<double> &real, vector<double> &imag)
{
...
void Ifft:: convolve(const vector<double> &xreal, const vector<double> &ximag, const vector<double> &yreal, const vector<double> &yimag, vector<double> &outreal, vector<double> &outimag)
{
...
void Ifft:: inverseTransform(std::vector<double> &real, std::vector<double> &imag)
{
